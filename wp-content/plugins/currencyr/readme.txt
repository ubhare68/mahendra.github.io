...
= Feedback =
If you have any feedback, tweet [@firmanw](http://twitter.com/firmanw) for fast response, or head over to the [support forum](http://wordpress.org/support/plugin/currencyr).
