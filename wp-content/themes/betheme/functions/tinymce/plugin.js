		...
		editor.addButton('mfnsc', {
			...
			menu : [ {
				...
				menu : [ {
					...
					text : 'Blog',
					onclick : function() {
						editor.insertContent('[blog count="2" category="" style="modern" columns="" greyscale="0" more="1" pagination="0"]');
					}
				}, {
					text : 'Blog News',
					onclick : function() {
					...
					text : 'Portfolio',
					onclick : function() {
						editor.insertContent('[portfolio count="2" category="" style="grid" columns="3" greyscale="0" orderby="date" order="DESC" pagination="0"]');
					}
				}, {
