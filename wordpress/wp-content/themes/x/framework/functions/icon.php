...
if ( ! function_exists( 'x_icon_comment' ) ) :
  function x_icon_comment( $comment, $args, $depth ) {
    ...
    <li id="li-comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
      <?php $comment_reply = ( ! function_exists( 'is_product' ) || function_exists( 'is_product' ) && ! is_product() ) ? '<div class="x-reply">' . get_comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Reply<span class="comment-reply-link-after"><i class="x-icon-reply"></i></span>', '__x__' ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ) . '</div>' : ''; ?>
      <?php
