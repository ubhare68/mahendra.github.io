...
<div id="primary" class="content-area">	
	<div id="main" class="site-main row" role="main">
		<?php $sub_class = (wdjewelry_check_layout('layout_template_first')?'col-sm-18':'col-sm-24'); ?>
		<!-- SHOW  SIDEBAR lEFT -->
		<?php
			if(get_theme_mod('layout_template_first','sidebar-right') === 'sidebar-left'):
				echo '<div class="col-sm-6 sidebar sidebar__left">';
				wdjewelry_get_sidebar('sidebar_template_first','layout_template_first');
				echo '</div>';
			endif;
		?>
		...
		<?php
			if(get_theme_mod('layout_template_first','sidebar-right') === 'sidebar-right'):
