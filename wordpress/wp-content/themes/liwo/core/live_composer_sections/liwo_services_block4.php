...
add_action('dslc_hook_register_modules',
     create_function('', 'return dslc_register_module( "Liwo_Services_Section4" );')
);

class Liwo_Services_Section4 extends DSLC_Module {
 		
 	// Module Attributes
    var $module_id = 'Liwo_Services_Section4';
    var $module_title = 'Service 4';
    ...
    function options() { 
    	...
    	$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.liwo_services_block4',
    ...
    function output( $options ) {
		...
		*/
		...
		?>	
		    <div class="one_full liwo_services_block4">
		        <ul class="lirc_section4">
		          <li class="left_two">
		          ...
		          <li class="right_two"><?php echo $services->post_excerpt; ?></li>
		        </ul>
		    </div>
