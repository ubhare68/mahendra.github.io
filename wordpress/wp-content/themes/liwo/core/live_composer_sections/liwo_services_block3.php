...
add_action('dslc_hook_register_modules',
     create_function('', 'return dslc_register_module( "Liwo_Services_Section3" );')
);

class Liwo_Services_Section3 extends DSLC_Module {
 		
 	// Module Attributes
    var $module_id = 'Liwo_Services_Section3';
    var $module_title = 'Service 3';
    ...
    function options() { 
    	...
    	$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.liwo_services_block3',
    ...
    function output( $options ) {
		...
		*/
		...
		?>	
		    <div class="one_full liwo_services_block3">
	          	<div class="lirc_section">
