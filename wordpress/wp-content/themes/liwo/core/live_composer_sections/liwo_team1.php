...
add_action('dslc_hook_register_modules',
     create_function('', 'return dslc_register_module( "Liwo_Team_Section1" );')
);

class Liwo_Team_Section1 extends DSLC_Module {
 		
 	// Module Attributes
    var $module_id = 'Liwo_Team_Section1';
    var $module_title = 'Team 1';
    	...
    	<?php
            ...
            ?>
                <div class="<?php echo $class_colums; ?> <?php if($dem%$options['amount']==0){ echo 'last'; } ?>">
                    ...
                    <h4><?php the_title( ); ?> <em>- <?php echo $position; ?></em></h4>
                    <ul class="people_soci">
                        ...
                        <li><a href="<?php echo $social_googleplus; ?>"><i class="fa fa-google-plus"></i></a></li>
                        <li><a href="<?php echo $social_linkedin; ?>"><i class="fa fa-linkedin"></i></a></li>
                        <li><a href="<?php echo $social_pinterest ?>"><i class="fa fa-pinterest"></i></a></li>
                    </ul>
