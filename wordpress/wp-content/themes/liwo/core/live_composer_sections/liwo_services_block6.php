...
add_action('dslc_hook_register_modules',
     create_function('', 'return dslc_register_module( "Liwo_Services_Section6" );')
);

class Liwo_Services_Section6 extends DSLC_Module {
 		
 	// Module Attributes
    var $module_id = 'Liwo_Services_Section6';
    var $module_title = 'Service 6';
    ...
    function options() { 
    	...
    	$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.liwo_services_block6',
    ...
    function output( $options ) {
		...
		*/
		...
		?>	
		    <div class="liwo_services_block6 inner">
		        <div class="one_full"> 
